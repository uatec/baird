...
public class VideoPlayer : OpenGlControlBase, IDisposable
{
    ...
    private void UpdateHud()
    {
        ...
        else
        {
            ...
            string posStr = _player.TimePosition;
            string durStr = _player.Duration;
    ...
    public async void SaveProgress(TimeSpan? positionOverride = null)
    {
        ...
        if (IsLive)
        {
            ...
            TimeSpan timeWatched = DateTime.Now - _currentVideoStartTime;
        ...
        else
        {
            ...
            TimeSpan currentPos = positionOverride ?? Position;
        ...
        TimeSpan position = positionOverride ?? Position;
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        {
            string? url = change.NewValue as string;
            if (!string.IsNullOrEmpty(url))
            {
                ...
                Avalonia.Threading.Dispatcher.UIThread.Post(() =>
                {
                    ...
                    {
                        TimeSpan start = ResumeTime.Value;
